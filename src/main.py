...
def main():
    ...
    parser.add_argument(
        "--mode",
        choices=["scenarios", "manual", "backtest", "live", "download-aemo", "download-nemosis"],
        default="backtest",
        help="Run mode: 'scenarios', 'manual', 'backtest', 'live', 'download-aemo', or 'download-nemosis' (default: backtest)"
    )
    parser.add_argument(
        "--file",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        help="Output file path for download modes (e.g., data/qld_prices_2026-05-01.csv)"
    )
    parser.add_argument(
        "--start-date",
        type=str,
    ...
    if args.mode == "scenarios":
        ...
        try:
            print(f"Downloading AEMO dispatch prices from {args.start_date} to {args.end_date}...")
